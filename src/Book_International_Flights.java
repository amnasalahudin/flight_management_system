...
public class Book_International_Flights extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Book_International_Flights frame = new Book_International_Flights(lst);
	 ...
	 * Create the frame.
	 */
	public Book_International_Flights(ArrayList<International> lst) {
		...
		// if the button is clicked then passenger menu frame is called 
		...
		JLabel lblBookLocalFlight = new JLabel("Book International Flight");
	    ...
	    btnNewButton_1.addMouseListener(new MouseAdapter() {
	    	...
	    	public void mouseClicked(MouseEvent e) {
	    		...
	    		// if the current seats are less than and equal to zero, prompt user to select another flight
	    		if(current1<=0)
	    		{
	    			JOptionPane.showMessageDialog(null, "Flight Seats Not Available, Please Select Another Flight!");
					return;
	    	...
	    	// caluclating the cost of the international flight
	    	obj.setNo_of_seats(noSeats);
	    	int cost = obj.getInternational_flight_cost();
	    	double tax = obj.getInternational_tax();
